...
""" 
This module defines a Economic Dispatch (ED) problem. It can consider variable generators and 
variable water cost. It needs as an input the on/off decisions of a Unit Commitment (UC) 
problem.
"""
